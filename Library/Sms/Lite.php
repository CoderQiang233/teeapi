...
class Sms_Lite
{
    ...
    public static function getAcsClient() {
        ...
        $accessKeyId = "LTAIfyeuFXVUI2YS"; // AccessKeyId

        $accessKeySecret = "8FcvN6LJX56sqfwL26vRFUiVGG4Sww"; // AccessKeySecret
     ...
     * @return stdClass
     */
    public static function sendSms($phoneNum,$templateCode,$param) {
