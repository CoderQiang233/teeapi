...
$di->response->addHeaders('Access-Control-Allow-Headers','AccessToken, Content-Type, WebOrigin,X-Requested-With,X_Requested_With,x-requested-with,content-type,authorization');
...
DI()->cache = new PhalApi_Cache_File(array('path' => API_ROOT . '/Runtime', 'prefix' => 'ntsd'));
